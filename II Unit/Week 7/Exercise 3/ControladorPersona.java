...
public class ControladorPersona{
	...
	static Persona[] arregloPersona=new Persona[5];


	public void ingresoArregloPersona() {
		...
		for(int x=0;x<arregloPersona.length;x++){	
			...
			System.out.println("Arreglo ["+x+"]: "+"Nombre y edad>> "+nombre+" "+apellido+", "+edad);
		}
	...
	public void busquedaPersona() {
		...
		for (Persona p:arregloPersona){
			...
			if (contador==arregloPersona.length){
